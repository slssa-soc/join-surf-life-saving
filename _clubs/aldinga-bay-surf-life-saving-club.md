...
permalink: '/clubs/aldinga-bay-surf-life-saving-club/'
...
latitude: -35.2776
longitude: 138.4446
member_size: 'Small to medium coastal club'
membership_fee_note: 'Seahorses fee publicly listed as  per Seahorse and parent/guardian inclusive. Nipper and general membership fees should be confirmed with the club.'
membership_fee_source: 'https://aldingabaysurflifesavingclub.com/wp-content/uploads/2025/10/Seahorse-info-and-FAQs-booklet.pdf'
...
best_for:
  ...
  - 'Children starting beach safety'
  - 'People looking for a smaller community club'
  - 'Members interested in inclusive junior participation'
commitment:
  id: 'flexible'
  label: 'Flexible'
adaptive_program: 'Seahorses inclusive program'
...
Aldinga Bay SLSC describes itself as a small volunteer organisation on the Fleurieu Peninsula, around 50 km south of Adelaide. The club provides rescue services on its stretch of coastline, patrols on weekends and public holidays during the summer season, and can support emergency out-of-hours callouts.
...
- Seahorses: publicly listed as  per Seahorse and parent/guardian inclusive.
