...
function render(r,test=false) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>Club Directory monthly report</title><style>@media(max-width:520px){.outer{padding:18px 10px!important}.metric{padding:16px!important}.column{display:block!important;width:100%!important;box-sizing:border-box}.heading{font-size:28px!important}}</style></head>
